...
//  [3, 6, 9, 12] => 3
//  [9, 20, 11, 12] => 8
// $(my_array).each(function( index, value ) {
//   index

 var bigDiff = function(array) {
  var largest_1 = Math.max.apply( Math, array );
  var largest_1_index = array.indexOf(largest_1);
  var num_1 = array.splice(largest_1_index, largest_1_index);
  var largest_2 = Math.max.apply( Math, array );
  var largest_2_index = array.indexOf(largest_2);
  var num_2 =array.splice(largest_2_index, largest_2_index);
